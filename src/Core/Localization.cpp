...
std::unordered_map<std::wstring, std::wstring> RussianStrings() {
    return {
        ...
        {L"dialog.interface_language_applies_after_restart", L"Язык интерфейса применится после перезапуска."},
        {L"dialog.language_will_apply_after_restart", L"Язык применится после перезапуска."},
        ...
        {L"dialog.selects_the_interface_language_after_application_restart", L"Выбирает язык интерфейса после перезапуска приложения."},
