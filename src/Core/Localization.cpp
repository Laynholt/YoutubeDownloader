...
std::unordered_map<std::wstring, std::wstring> RussianStrings() {
    return {
        ...
        {L"dialog.sponsorblock", L"SponsorBlock"},
        {L"dialog.sponsorblock_segments_to_remove", L"Какие рекламные сегменты удалять после загрузки."},
        {L"dialog.sponsorblock_off", L"Ничего не вырезать"},
        {L"dialog.sponsorblock_sponsor", L"Только спонсорские интеграции"},
